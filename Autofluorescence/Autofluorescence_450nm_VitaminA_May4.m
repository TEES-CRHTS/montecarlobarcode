function [VitaminA] = Autofluorescence_450nm_VitaminA_Feb21(nphoton,resolution,lambda1,lambda2)
fprintf('\n');
...
j=4;
mediaProperties(j).name = 'VitaminA';
B = 0.002;
S = 0.67;
W = 0.65;
Me = 0;
...
b=a1(:,1)-parameters; 
c=find(b(:,1)==0);
mediaProperties(j).mua  = .009*2.3; %.0005
mediaProperties(j).mus  = musp/(1-gg);
mediaProperties(j).g    = gg;
mediaProperties(j).n    = 1.3;
mediaProperties(j).Y    = .03*a1(c,3); %https://www.sciencedirect.com/science/article/pii/0024320588903049 
end
